...
public class DatasetTest extends junit.framework.TestCase {
    ...
    public void testMissingValueError() {
    ...
    public void testConstructorKeysAndValues_basics() {
    ...
    public void testConstructorKeysAndValues_ignoreExtraKey() {
        Dataset d = new Dataset("a", "a_value", "b");
        assertEquals("first value", "a_value", d.get("a"));
        assertEquals("number of values", 1, d.size());
    }

    public void testGetFileInstance_noExtension() {
    ...
    public void testGetFileInstance_ymlExtension() {
    ...
    public void testGetFileInstance_yamlExtension() {
    ...
    public void testGetFileInstance_unknownExtension() {
        boolean gotException = false;
        try {
    ...
    public void testGet_basics() {
        Dataset d = new Dataset("a", "a_value", "b", "b_value");
        assertEquals("first value", "b_value", d.get("b"));
    }
    public void testGet_searchChain() {
        Dataset d = new Dataset("a", "a_value", "b", "b_value");
        Dataset d2 = new Dataset();
    ...
    public void testGet_missingValue() {
        boolean gotException = false;
    ...
    public void testGetChild_missingValue() {
        boolean gotException = false;
        Dataset d = new Dataset("a", "a_value");
        try {
            d.getChild("x");
    ...
    public void testGetChildren_basics() {
    ...
    public void testGetChildren_searchChain() {
        Dataset d = new Dataset("a", "a_value", "b", "b_value");
        Dataset d2 = new Dataset();
    ...
    public void testGetChildren_keyExists() {
        boolean gotException = false;
    ...
    public void testGetPath_multiLevelPath() {
        boolean gotException = false;
        Dataset d = new Dataset("a", "a_value");
        try {
            d.getPath("a.b.c");
    ...
    public void testLookupPath_multiLevelPath() {
        boolean gotException = false;
        Dataset d = new Dataset("a", "a_value");
        try {
