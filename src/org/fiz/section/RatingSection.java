 ...
 *                      dataset and any passed in {@code data}.
 ...
 *                      and the {@code data} dataset property will be searched.
 *                      For instance, if {@code data} is specified with
 *                      containing {myrating : 3.2}, then setting
 ...
 *   data:              (optional) Supplies data for any of the specified
 *                      templates ({@code ajaxUrl}, {@code initRatingKey},
 *                      {@code unratedMessage}).
...
public class RatingSection extends Section implements DirectAjax {
    ...
    public void render(ClientRequest cr) {
        ...
        Dataset templateData = properties.checkDataset("data");
        if (templateData != null) {
            if (templateData.containsKey("record")) {
                templateData = templateData.getDataset("record");
            }
            templateData = new CompoundDataset(templateData, cr.getMainDataset());
        } else {
