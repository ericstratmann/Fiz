...
public class Dataset implements Cloneable, Serializable {
    ...
    // the errors associated with this dataset.  Null means setError has not
    // been called.
    ...
    /**
     * Constructs an empty dataset with error information generated from the
     * exception.
     *
     * @param e               Used to generate error information
     */
    public Dataset(Exception e) {
        map = new HashMap<String,Object>();
        setError(e);
    }
    ...
    /**
     * Associates an array of errors with this dataset. After this method has
     * been invoked, any method not dealing with errors will
     * throw an exception instead. This method should be invoked at most once.
     * The following values in the dataset(s) have well-defined interpretation
     * and usage, so they should be included whenever appropriate, though
     * additional values can be provided.
     ...
     */
    public void setError(Dataset... errorInfo) {
        errorDatasets = errorInfo;
    }

    /**
     * Associates an ArrayList of errors with this dataset.
     * @param errorInfo            One or more datasets, each containing
     *                             information about one error that occurred
     *                             while processing the request.
     */
    public void setError(ArrayList<Dataset> errorInfo) {
    ...
    /**
     * Associates error information with this dataset generated from the given
     * Throwable. This method creates three values: message, exception, and
     * exceptionName.
     * @param error           Used to generate error information
     */
    public void setError(Throwable error) {
        setError(new Dataset("message", error.getMessage(), "exception",
                     error, "exceptionName", error.getClass().getSimpleName()));
    }

    /**
     * Returns detailed information about the error(s) associated with this
     * dataset, if there were any.
     * @return                     An array of datasets; each dataset
     *                             contains elements describing one error.
     *                             If there were no errors, null is returned.
     */
     ...
     * @return                     A description of the problem(s),
     *                             intended for presentation to users (as
     *                             opposed to system maintainers). If there were
     *                             no errors, null is returned.
     */
     ...
     * for the error(s) associated with this dataset; intended for logs
    ...
    /**
     * Throws an InternalError if there are any errors associated with this
     * dataset.
     */
    public void throwIfError() {
        if (errorDatasets != null) {
            throw new DatasetError(errorDatasets);
        }
    }
}
