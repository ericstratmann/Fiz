...
public class ImageSelectorTest extends junit.framework.TestCase {
	...
	public void test_html_keyNotInDataset() {
    	Dataset data = new Dataset("id", "baz", "map", new Dataset());
		is = new ImageSelector(data);
		try {
			is.html(cr, testRow, out);
		} catch (Dataset.MissingValueError e) {
	...
	public void test_html_keyNotFoundNoDefault() {
	...
	public void test_html_keyNotFoundUseDefault() {
		Dataset data = new Dataset("id", "foo", "map", new Dataset(
				"default", "default.png"));
		is = new ImageSelector(data);
		is.html(cr, testRow, out);
	...
	public void test_html_valueIsString() {
		Dataset data = new Dataset("id", "foo", "map", new Dataset(
				"bar", "bar.png"));
		is = new ImageSelector(data);
		is.html(cr, testRow, out);
	...
	public void test_html_valueIsDatasetNoSrc() {
		Dataset data = new Dataset("id", "foo", "map", new Dataset(
				"bar", new Dataset()));
		is = new ImageSelector(data);
		try {
	...
	public void test_html_valueIsDatasetWithAlt() {
		Dataset data = new Dataset("id", "foo", "map", new Dataset(
				"bar", new Dataset(
				"src", "bar.png", "alt", "baz")));
		is = new ImageSelector(data);
	...
	public void test_html_valueIsDatasetWithoutAlt() {
		Dataset data = new Dataset("id", "foo", "map", new Dataset(
	...
	public void test_html_useTemplate() {
