...
public class TreeSectionTest extends junit.framework.TestCase {
    ...
    public void test_ajaxExpand() {
        ...
        TreeSection.PageProperty p = new TreeSection.PageProperty("TreeSection",
                ...
                "section.TreeSectionTest$DataFactory.data");
        p.names.put("tree1_2", "node16");
        cr.setPageProperty("tree1",  p);
        cr.jsCode = null;
        Dataset main = cr.getMainDataset();
        main.clear();
        main.set("sectionId", "tree1");
        main.set("nodeId", "tree1_2");
    ...
    public void test_render_basics() {
        TreeSection tree = new TreeSection(new Dataset("id", "tree14",
                "dataFactory", "section.TreeSectionTest$DataFactory.data"));
        tree.render(cr);
    ...
    public void test_render_withRootName() {
        TreeSection tree = new TreeSection(new Dataset("id", "1234",
                "dataFactory",
                "org.fiz.section.TreeSectionTest$DataFactory.data",
    ...
    public void test_renderChildren_javascriptForExpandableElement() {
        ...
        TreeSection.PageProperty p = new TreeSection.PageProperty("TreeSection",
                ...
                "none");
        TreeSection.renderChildren(cr, p, children, "tree1_3", out);
        String javascript = cr.getHtml().getJs();
        assertEquals("accumulated Javascript",
                ...
                "Fiz.ids['tree1_3_0'].unexpand();\\\"" +
                " onmouseover=\\\"Fiz.changeImage('tree1_3_0_minus', " +
                "'treeSolid-minus-active.gif');\\\"" +
                " onmouseout=\\\"Fiz.changeImage('tree1_3_0_minus', " +
                "'treeSolid-minus.gif');\\\">" +
                "<img id=\\\"tree1_3_0_minus\\\" src=\\\"/static/fiz/" +
